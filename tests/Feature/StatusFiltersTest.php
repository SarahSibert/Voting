...
class StatusFiltersTest extends TestCase
{
    ...
    public function filtering_works_when_query_string_in_place()
    {
        ...
        $response->assertSee('<button class="bg-yellow-500 text-white text-xs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4">In Progress</button>', false);
        $response->assertDontSee('<button class="bg-purple-500 text-white text-xs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4">Considering</button>', false);
    }
    ...
    public function index_page_shows_selected_status()
    {
        ...
        $response->assertSee('border-blue-400 text-gray-900');
    }
}
