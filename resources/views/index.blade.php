            ...
            <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
                ...
                <div class="w-full flex flex-col justify-between mx-4">
                    <h4 class="mt-2 md:mt-0 text-xl font-semibold">
                        <a href="#" class="hover:underline">First One</a>
                    </h4>
                    <div class="text-gray-600 mt-3 line-clamp-3">
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit. bitis illum iusto blanditiis incidunt ipsam vero!
                    </div>
                    <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                        ...
                        <div class="flex items-center md:hidden mt-4 md:mt-0">
                             ...
                             <button
                                 class="w-20 bg-gray-200 border border-gray-200 font-bold text-xs uppercase rounded-xl hover:border-gray-400 transition duration-150 ease-in px-4 py-3 -mx-5"
                             >
                                 Vote
                             </button>
                        </div>
