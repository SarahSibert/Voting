<div 
    ...
    <div class="hidden md:block border-r border-gray-100 px-5 py-8">
        ...
        <div class="mt-8">
            @if ($hasVoted)
                 <button class="w-20 bg-blue-500 text-white border border-blue-500 hover:bg-blue-700 font-bold text-xxs uppercase rounded-xl transition duration-150 ease-in px-4 py-3">Voted</button>
             @else
